...
<context>
    ...
    <message>
        ...
        <translation>Координация</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Это приложение Stopmotion. Оно помогает создавать stop-motion анимацию.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ниже вы можете указать, какое устройство Stopmotion должен использовать для захвата изображений.</translation>
    </message>
    <message>
        ...
        <translation>Вы можете выбрать из устройств, обнаруженных автоматически или добавить устройства самостоятельно. Если вы не очень опытный пользователь, не рекомендуется использовать устройства, которые не удалось обнаружить автоматически.</translation>
    </message>
    <message>
        ...
        <translation>Выбранное устройство будет обозначено как макрос &lt;b&gt;$VIDEODEVICE&lt;/b&gt; на вкладке Импорт Видео.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Имя файла для вывода по умолчанию:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ниже вы можете указать, какую программу или процесс Stopmotion должен использовать для перекодирования текущего проекта в видеофайл.</translation>
    </message>
    <message>
        ...
        <translation>Вы всегда должны использовать макросы &lt;b&gt;$IMAGEPATH&lt;/b&gt; и &lt;b&gt;$VIDEOFILE&lt;/b&gt; соответственно для обозначения пути к файлам изображений и видеофайла.</translation>
    </message>
    <message>
        ...
        <translation>Пример использования утилиты mencoder (jpeg images to mpeg4 video):</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Аргументы для передачи программе:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вывод внешней программы</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Кадр номер: </translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Добавить звук&lt;/h4&gt; &lt;p&gt;Этой кнопкой вы можете &lt;em&gt;добавить звук&lt;/em&gt; в выбранный кадр.&lt;/p&gt; &lt;p&gt;Звук начнёт воспроизводиться в момент начала кадра и будет проигрываться до его завершения.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Убрать звук&lt;/h4&gt; &lt;p&gt;Этой кнопкой вы можете &lt;em&gt;удалить&lt;/em&gt; выбранный звук из этого кадра.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Переименовать&lt;/h4&gt; &lt;p&gt;Этой кнопкой вы можете переименовать выбранный звук. &lt;BR&gt;Название звука не несёт никакой функциональной нагрузки, оно лишь упрощает работу с анимацией.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Звуки&lt;/h4&gt; &lt;p&gt;В этом списке указаны все звуки, связанные с этим кадром.&lt;/p&gt;&lt;p&gt;Звуки начначинают воспроизводиться в момент начала кадра и проигрываются от начала до конца.&lt;/p&gt;</translation>
    </message>
</context>
<context>
    <name>FrameView</name>
...
This can be set in the preferences menu.</source>
        <translation>Вы должны определить устройство для захвата изображений.
Это можно сделать в меню настроек.</translation>
    </message>
    <message>
        ...
        <translation>Не задана команда предварительного просмотра</translation>
    </message>
    <message>
        ...
        <translation>Данное устройство захвата не установлено в вашем компьютере</translation>
    </message>
    <message>
        ...
        <translation>Не выбрано устройство захвата в меню настроек.</translation>
    </message>
</context>
<context>
    <name>ImportTab</name>
    ...
    <message>
        ...
        <translation>Команда предварительного просмотра</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ниже вы можете указать, какую программу или процеес Stopmotion должен использовать для захвата кадров с помощью заданного устройства.</translation>
    </message>
    <message>
        ...
        <translation>Вы всегда должны использовать макросы &lt;b&gt;$VIDEODEVICE&lt;/b&gt; и &lt;b&gt;$IMAGEFILE&lt;/b&gt; соответственно для обозначения устройства захвата и файла захваченного изображения.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Справка программы Stopmotion</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Всегда готов ;-)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Открыть&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Открывает&lt;/em&gt; файл проекта Stopmotion.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Выход&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Выход&lt;/em&gt; из программы.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Отменить&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Отменяет&lt;/em&gt; последнее действие. Вы можете нажать Отменить несколько раз, чтобы отменить сделанные ранее действия.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Повторить&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Повторяет&lt;/em&gt; последнее действие. Вы можете нажать Повторить несколько раз, чтобы повторить операцию несколько раз.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Вырезать&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Вырезает&lt;/em&gt; выбранные кадры из анимации и помещает их в буфер обмена, чтобы вы могли их вставить в другом месте.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Копировать&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Копирует&lt;/em&gt; tвыделенные кадры в буфер обмена. После этого вы можете вставить их в другом месте.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Вставить&lt;/h4&gt; &lt;p&gt;&lt;em&gt;Вставляет&lt;/em&gt; кадры из буфера обмена в выбранное место.&lt;/p&gt; &lt;p&gt;Вы можете скопировать/вырезать избражения из других мест или программ и использовать эту функцию для для их вставки в вашу анимацию.&lt;/p&gt;</translation>
    </message>
    <message>
        <location filename="../src/presentation/frontends/qtfrontend/mainwindowgui.cpp" line="485"/>
        <source>&amp;Go to frame</source>
        <translation>&amp;Перейти к кадру</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Перейти к кадру&lt;/h4&gt; &lt;p&gt;Открывает меню в нижней части окна. Там вы можете выбрать кадр, к которому вы хотите &lt;em&gt;перейти&lt;/em&gt;.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Что это?&lt;/h4&gt; &lt;p&gt;Превращает ваш курсор в значок &quot;Что это?&quot;. Указав курсором на интересующий вас элемент, вы получите информацию о нём.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;О программе&lt;/h4&gt; &lt;p&gt;Будет показано небольшое окно, содержащее общую информацию об этом прекрасном приложении, а так же имена людей, принимавших участие в его создании.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Монтажный стол&lt;/h4&gt; &lt;p&gt;В этой области вы может видеть кадры и сцены вашей анимации. Перемещая их, создавайте свои видео.&lt;/p&gt;&lt;p&gt;Вы можете переключаться между предыдущим и следующим кадром с помощью &lt;b&gt;клавиш со стрелками&lt;/b&gt; или &lt;b&gt;x&lt;/b&gt; и &lt;b&gt;z&lt;/b&gt;&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Меню инструментов&lt;/h4&gt; &lt;p&gt;Это меню инструментов, где находится большинство кнопок и виджетов, которые вам нужны, когда вы занимаетесть покадровой анимацией.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Меню свойств кадра&lt;/h4&gt; &lt;p&gt;В этом меню вы можете установить такие свойства выбранного кадра (или нескольких кадров), как &lt;b&gt;субтитры&lt;/b&gt;, &lt;b&gt;звуковые эффекты&lt;/b&gt; и т.д.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Меню перехода к кадру&lt;/h4&gt; &lt;p&gt;Здесь вы можете указать номер кадра и программа перейдёт к нему&lt;/p&gt; </translation>
    </message>
    <message>
        <location filename="../src/presentation/frontends/qtfrontend/mainwindowgui.cpp" line="494"/>
        <source>Go to frame:</source>
        <translation>Переход к кадру:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Панель кадра&lt;/h4&gt;&lt;p&gt; В этой области отображается выбранный кадр. Также, при нажатии кнопки &lt;b&gt;Воспроизведение&lt;/b&gt; здесь воспроизводится ваша анимация.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменения не были сохранены. Вы хотите сохранить их?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Видео&lt;/h4&gt; &lt;p&gt;Экспортирует текущий проект в &lt;em&gt;видеофайл&lt;/em&gt;.&lt;/p&gt;Мастер экспорта поможет вам с этой задачей.</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Cinerella&lt;/h4&gt; &lt;p&gt;Экспортирует текущую анимацию в виде файла проекта &lt;em&gt;Cinerella&lt;/em&gt;.&lt;/p&gt;Мастер экспорта поможет вам с этой задачей.</translation>
    </message>
    <message>
        <location filename="../src/presentation/frontends/qtfrontend/mainwindowgui.cpp" line="478"/>
        <source>Cinelerra</source>
        <translation>Cinerella</translation>
    </message>
    <message>
        <location filename="../src/presentation/frontends/qtfrontend/mainwindowgui.cpp" line="486"/>
        <source>&amp;Configure Stopmotion</source>
        <translation>&amp;Настроить Stopmotion</translation>
    </message>
    <message>
...
have setted an encoder to use. Do you want to set it now?</source>
        <translation>Не могу найти ни одного кодировщика для экспорта
видео.Они могут быть установлены в меню настроек.
Экспорт в видеофайл не будет возможен до тех пор,
 пока вы не настроите кодировщика.
Хотите настроить его прямо сейчас?</translation>
    </message>
    <message>
        <location filename="../src/presentation/frontends/qtfrontend/mainwindowgui.cpp" line="901"/>
        <source>Export to video file</source>
        <translation>Экспорт в видеофайл</translation>
    </message>
    <message>
...
Хотите проверить его параметры?</translation>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Справка&lt;/h4&gt; &lt;p&gt;Эта кнопка открывает окно справки Stopmotion&lt;/p&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Выберите кадры для добавления</translation>
    </message>
    <message>
        <location filename="../src/application/modelhandler.cpp" line="143"/>
        <source>Removed the selected frame</source>
        <translation>Выбранный кадр был удалён</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Самая простая настройка. Довольно медлленно</translation>
    </message>
    <message>
        ...
        <translation>Экспортирует изображения jpeg в видео mpeg1</translation>
    </message>
    <message>
...
Хотите его использовать? (Ваш старый файл конфигурации будет сохранён с именем ~/.stopmotion/preferences.xml.OLD)</translation>
    ...
    <message>
        ...
        <translation>Экспортирует изображения jpeg в видео mpeg2</translation>
    </message>
    <message>
        ...
        <translation>Экспортирует изображения jpeg в видео mpeg4</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Захват с DV-камеры.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Проигрываем анимацию</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Введите имя звука:</translation>
    </message>
    <message>
        <location filename="../src/application/soundhandler.cpp" line="45"/>
        <source>Choose sound file</source>
        <translation>Выберите файл звука</translation>
    </message>
</context>
<context>
    <name>ToolsMenu</name>
    <message>
        ...
        <translation>Выбор FPS</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Выбор FPS&lt;/h4&gt; &lt;p&gt;Изменяя это значение, вы устанавливаете, с какой скоростью должно воспроизводиться видео в &lt;b&gt;Панели кадра&lt;/b&gt;.&lt;/p&gt; &lt;p&gt;Чтобы начать воспроизведение нажмите на кнопку &lt;b&gt;Воспроизведение&lt;/b&gt;.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Добавить кадры (CTRL+F)&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы &lt;em&gt;добавить&lt;/em&gt; кадры в анимацию.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Удалить кадры (Delete)&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы &lt;em&gt;удалить&lt;/em&gt; выбранные кадры из анимации.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Новая сцена (CTRL+E)&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы &lt;em&gt;создать&lt;/em&gt; новую &lt;em&gt;сцену&lt;/em&gt; в анимации.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Удалить сцену (SHIFT+Delete)&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы&lt;em&gt;удалить&lt;/em&gt; выбранную сцену из анимации.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Включает/выключает камеру (C)&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы включить/выключить камеру&lt;/p&gt; </translation>
    </message>
    <message>
        ...
        <translation>&lt;h4&gt;Захват кадра (Пробел)&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы &lt;em&gt;захватить&lt;/em&gt; кадр с камеры и вставить его в анимацию&lt;/p&gt; &lt;p&gt; То же самое можно сделать, нажав на клавишу &lt;b&gt;Пробел&lt;/b&gt;&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Закольцевать (CTRL+L)&lt;/h4&gt; &lt;p&gt;Эта кнопка определяет, будет ли анимация воспроизведена один раз от начала до конца, либо будет восроизводиться бесконечно в цикле.&lt;/p&gt;</translation>
    </message>
    <message>
...
to running the image grabbing as a deamon.</source>
        <translation>Сейчас режим воспроизведения работает только в случае, 
...
захват кадров при помощи процесса.</translation>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Запустить Gimp&lt;/h4&gt; &lt;p&gt;Нажмите эту кнопку, чтобы открыть текущий кадр в Gimp.&lt;/p&gt; &lt;p&gt;Также вы можете перетаскивать кадры с монтажного стола в окно Gimp&lt;/p&gt;</translation>
    </message>
</context>
</TS>