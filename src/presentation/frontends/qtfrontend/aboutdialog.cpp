	...
	: QDialog(parent)
{
	...
	layout->addWidget( new QLabel(
				...
				"<p> &copy; 2005-2008, Bj�rn Erik Nilsen and Fredrik Berg Kj�lstad </p>"));
	...
	tabWidget->addTab( new QLabel(
				...
				"Bj�rn Erik Nilsen &lt;bjoern.nilsen@bjoernen.com&gt;<br>" 
	...
	qte->setHtml( 
				...
				"Jos� Jorge &lt;jjorge@free.fr&gt; (" + tr("Portuguese") + ")<br>"
				"Manuel Qui�ones &lt;manuel.por.aca@gmail.com&gt; (" + tr("Spanish") + ")<br>"
				"David Hjelm &lt;dav.hjelm@spray.se&gt; (" + tr("Swedish") + ")<br>"
				"Koray L�ker &lt;loker@pardus.org.tr&gt; (" + tr("Turkish") + ")<br>"
