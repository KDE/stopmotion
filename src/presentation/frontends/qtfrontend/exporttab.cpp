...
{
	QGridLayout *mainGrid = new QGridLayout(this, 1, 1, 3);
	...
	encoderPrefs->hide();
	QGridLayout *settingsGrid = new QGridLayout(encoderPrefs, 1, 1, 3);
	
	QPushButton *closeButton = new QPushButton(encoderPrefs);
	closeButton->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
	closeButton->setPixmap(closeicon);
	closeButton->setFlat(true);
	connect( closeButton, SIGNAL(clicked()),this, SLOT(closeSettings()) );
	
	QLabel *askForOutput = new QLabel( 
	...
	QLabel *startEncoderLabel = new QLabel( tr("Start encoder:"), encoderPrefs );
	...
	QLabel *stopEncoderLabel = new QLabel( tr("Stop encoder:"), encoderPrefs );
